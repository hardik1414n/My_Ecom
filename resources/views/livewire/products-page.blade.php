              ...
              <div class="w-full pr-2 lg:w-1/4 lg:block">
                ...
                <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                  ...
                  <div class="font-semibold">
                    ...
                    <input wire:model.live='price_range' type="range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="500000" value="300000" step="1000">
                    ...
                    <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key='{{ $product->id }}'>
                        <div class="border border-gray-300 dark:border-gray-700">
                          <div class="relative bg-gray-200">
                            <a wire:navigate href="/products/{{ $product->id }}" class="">
                              <img src="{{ url('storage',$product->images[0]) }}" alt="{{ $product->name }}" class="object-cover h-60 mx-auto ">
                            </a>
                          </div>
                          <div class="p-3 ">
